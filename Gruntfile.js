  ...
  grunt.initConfig({
    ...
    cssmin: {
       dist: {
         ...
         files: {
           '<%= config.dist %>/css/mobile.style.css': [
             '<%= config.app %>/Public/css/mobile.style.css'
           ],
           '<%= config.dist %>/css/style.css': [
             '<%= config.app %>/Public/css/style.css'
           ],
    ...
    uglify: {
       //dist: {
       //  files: {
       //    '<%= config.dist %>/scripts/tools.js': [
       //      '<%= config.app %>/scripts/tools.js'
       //    ],
       //    '<%= config.dist %>/scripts/scrollInit.js': [
       //      '<%= config.app %>/scripts/scrollInit.js'
       //    ]
       //  }
       //}
        my_target: {
